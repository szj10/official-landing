...
export function QueueStatusCard({
  ...
  if (isCompleted) {
    return (
      <div className="animate-in slide-in-from-bottom-3 fade-in duration-300">
        <div className="rounded-2xl border border-emerald-200/80 dark:border-emerald-800/60 bg-emerald-50/60 dark:bg-emerald-950/30 p-3 sm:px-4 sm:py-3.5 backdrop-blur-sm">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2.5 min-w-0 flex-1">
              <div className="w-8 h-8 rounded-xl bg-emerald-500 text-white shadow-sm shadow-emerald-500/30 flex items-center justify-center shrink-0">
                <svg
                  className="w-4 h-4"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <div className="truncate min-w-0">
                ...
                <p className="text-[11px] text-emerald-600 dark:text-emerald-400 font-medium truncate leading-tight mt-0.5">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              {onDismissCompleted && (
                <button
                  ...
                  className="p-1 text-emerald-700/60 hover:text-emerald-800 dark:text-emerald-400/60 dark:hover:text-emerald-200 rounded-lg hover:bg-emerald-200/50 dark:hover:bg-emerald-900/40 transition-colors"
  ...
  if (generationStatus === "processing") {
    return (
      <div className="animate-in slide-in-from-bottom-3 fade-in duration-300">
        <div className="rounded-2xl border border-gray-200/80 dark:border-zinc-700/60 bg-gray-50/80 dark:bg-zinc-800/60 p-3 sm:px-4 sm:py-3.5 flex flex-col gap-2.5 backdrop-blur-sm">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2.5 min-w-0 flex-1">
              <div className="w-8 h-8 rounded-xl bg-indigo-600 text-white shadow-sm shadow-indigo-500/30 flex items-center justify-center shrink-0">
              ...
              <div className="truncate min-w-0">
                ...
                <p className="text-[11px] text-indigo-600 dark:text-indigo-400 font-medium truncate leading-tight mt-0.5">
          ...
          <div className="h-1.5 w-full rounded-full bg-gray-200 dark:bg-zinc-700 overflow-hidden relative shadow-inner">
            <div
          ...
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            ...
            <div className="truncate min-w-0">
              <div className="flex items-center gap-2">
                ...
                {hasMetrics && (
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-indigo-100 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 border border-indigo-200/50 dark:border-indigo-800/50 shrink-0">
                    {pos === 1
              ...
              <p className="text-[11px] text-gray-500 dark:text-zinc-400 font-medium truncate leading-tight mt-0.5">
                {hasMetrics
                  ? pos === 1
                    ? t("playground.queue.nextInLine")
          ...
          <div className="flex items-center gap-3 shrink-0">
            {hasMetrics && wait > 0 && (
              <div className="text-right">
                <span className="text-xs font-bold font-mono text-gray-900 dark:text-zinc-100 tabular-nums">
                  {waitLabel}
                </span>
                <span className="block text-[9px] uppercase font-semibold text-gray-400 dark:text-zinc-500 tracking-wider">
