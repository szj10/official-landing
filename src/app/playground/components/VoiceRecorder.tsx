...
export function VoiceRecorder({
  ...
  return (
    <div className="flex flex-col items-center w-full space-y-4">
      ...
      {/* 2. Recording Console */}
      <div className="w-full flex flex-col items-center p-4 sm:p-5 bg-gray-50/70 dark:bg-zinc-900/40 rounded-2xl border border-gray-200/80 dark:border-zinc-800 space-y-4">
      ...
      {/* 3. Saved Voice Prompts Section */}
      {historyVoices.length > 0 && (
        <div className="w-full pt-3 border-t border-gray-200/80 dark:border-zinc-800 space-y-2.5">
          <div className="flex items-center justify-between px-1">
            ...
            {onToggleShowHistoryVoices && (
              ...
              >
                <ChevronIcon className="w-4 h-4" open={showHistoryVoices} />
              </button>
            )}
          </div>
