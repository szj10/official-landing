...
export function VoiceRecorder({
  ...
  const [openSection, setOpenSection] = useState<AccordionSection>("record");
  ...
  const toggleSection = (section: AccordionSection) => {
    setOpenSection((prev) =>
      prev === section ? (section === "record" ? "history" : "record") : section
    );
  };
      ...
      <div className="w-full rounded-2xl border border-gray-200/80 dark:border-zinc-800 overflow-hidden divide-y divide-gray-200/80 dark:divide-zinc-800">
        ...
        <div>
          ...
          >
            ...
            <ChevronIcon className="w-4 h-4 text-gray-400" open={openSection === "record"} />
          </button>

          {openSection === "record" && (
            <div className="w-full flex flex-col items-center p-4 sm:p-5 bg-gray-50/40 dark:bg-zinc-900/20 space-y-4">
              {recordedAudioBlob || uploadStatus === "success" ? (
        ...
        {/* Panel B: Saved Voice Prompt History */}
        {historyVoices.length > 0 && (
          <div>
            <button
              type="button"
            ...
            >
              ...
              <ChevronIcon className="w-4 h-4 text-gray-400" open={openSection === "history"} />
            </button>

            {openSection === "history" && (
              <div className="p-3 bg-gray-50/40 dark:bg-zinc-900/20 space-y-2 max-h-52 overflow-y-auto custom-scrollbar">
                {historyVoices.map((voice) => {
                  ...
                  const durationStr = voice.audio_duration
                    ...
                    : "0:10";
                  const relativeTimeStr = voice.created_at
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        {/* Main Title: Duration & Relative Time; Subtitle: Voice ID */}
